    ...
    for k = 1 : length(srcFiles)
       ...
       [I] = amf(A,7);
        ...
        if a == 1
            ...
            data1 = cat(1,data1, [co_rel std_err sk k e m v 1]);
        
        elseif a == 2
            
            % Putting malignant training data in data2.
            
            data2 = cat(1,data2,[co_rel std_err sk k e m v 0]);
        
        elseif a == 3
        
            % Putting Bening testing data in data3.
            
            data3 = cat(1,data3,[co_rel std_err sk k e m v 1]);
            
        elseif a == 4
            
            % Putting Malignant testing data in data4.
            
            data4 = cat(1,data4,[co_rel std_err sk k e m v 0]);
...
testbenign = [data3(:,1) data3(:,2) data3(:,3) data3(:,4) data3(:,5) data3(:,6) data3(:,7)];
testcancerous = [data4(:,1) data4(:,2) data4(:,3) data4(:,4) data4(:,5) data4(:,6) data4(:,7)];
trainbenign = [data1(:,1) data1(:,2) data1(:,3) data1(:,4) data1(:,5) data1(:,6) data1(:,7)];
traincancerous = [data2(:,1) data2(:,2) data2(:,3) data2(:,4) data2(:,5) data2(:,6) data2(:,7)];
